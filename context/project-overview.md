...
| ⬜ File _(Pro)_  | file  | `#6b7280` (gray)    | `File`              | `/items/files`    |
| 🟥 Image _(Pro)_ | file  | `#ec4899` (pink)    | `Image`             | `/items/images`   |
...
A **Collection** groups items of _any_ type. An item can belong to **multiple collections** — e.g. a React snippet living in both _React Patterns_ and _Interview Prep_ — handled through a join table.
...
| Cache        | [Redis](https://redis.io/) _(maybe)_                                              | Caching layer                                                            |
